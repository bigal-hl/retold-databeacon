...
if(!this.options.SkipRouteResolveOnAdd&&!this.pict.settings.RouterSkipRouteResolveOnAdd){this.resolve();}}/**
	 ...
	 *
	 */resolve(){this.router.resolve();}}module.exports=PictRouter;module.exports.default_configuration=_DEFAULT_PROVIDER_CONFIGURATION;},{"navigo":3,"pict-provider":12}],14:[function(require,module,exports){/**
...
const libCodeDemos=require('./demos');module.exports.demos=libCodeDemos.demos;module.exports.registerWithDocuserve=libCodeDemos.registerWithDocuserve;},{"./Pict-Code-Highlighter.js":14,"./Pict-Section-Code-DefaultConfiguration.js":15,"./demos":17,"pict-view":80}],17:[function(require,module,exports){/**
 ...
 */function registerWithDocuserve(pPict){if(!pPict||!pPict.providers||!pPict.providers['Docuserve-Demos']){return 0;}return pPict.providers['Docuserve-Demos'].registerAll(_Demos);}module.exports=_Demos;module.exports.demos=_Demos;module.exports.registerWithDocuserve=registerWithDocuserve;},{"../Pict-Section-Code.js":16}],18:[function(require,module,exports){/**
...
SchemasAddress:'AppData.Connection.Schemas',ActiveAddress:'AppData.Connection.ActiveProvider',FieldIDPrefix:'pict-conn',ShowProviderSelect:true,ShowAdvancedToggle:true};},{}],19:[function(require,module,exports){/**
...
module.exports.registerCatalog=registerCatalog;module.exports.listCatalog=listCatalog;module.exports.install=install;module.exports.clearPersistence=clearPersistence;},{"./Theme-Brand.js":31,"./Theme-Persistence.js":33,"./Theme-Scale.js":34,"./themes/_catalog.js":38,"./views/PictView-Theme-BottomBar.js":69,"./views/PictView-Theme-Brand-Mark.js":70,"./views/PictView-Theme-BrandStrip.js":71,"./views/PictView-Theme-Button.js":72,"./views/PictView-Theme-ModeToggle.js":73,"./views/PictView-Theme-Picker.js":74,"./views/PictView-Theme-ScaleSelect.js":75,"./views/PictView-Theme-TopBar.js":76,"pict-provider":12,"pict-provider-theme":6}],31:[function(require,module,exports){/**
...
this.pict.views.Layout.render();// Load initial data.
let tmpProvider=this.pict.providers.DataBeaconProvider;if(tmpProvider){tmpProvider.loadConnections();tmpProvider.loadAvailableTypes();tmpProvider.loadEndpoints();tmpProvider.loadBeaconStatus();}// Land on the dashboard.
this.navigateTo('Dashboard');return super.onAfterInitializeAsync(fCallback);}// ── Router action handlers ──────────────────────────────────────────────
...
_form(pViewName){return this.pict.views[pViewName]||{_submit:()=>{}};}}module.exports=DataBeaconApplication;module.exports.default_configuration={};},{"./DataBeacon-Brand.js":82,"./providers/Pict-Provider-DataBeacon-Export.js":85,"./providers/Pict-Provider-DataBeacon-Icons.js":86,"./providers/Pict-Provider-DataBeacon-SavedQueries.js":87,"./providers/Pict-Provider-DataBeacon.js":88,"./providers/PictRouter-DataBeacon-Configuration.json":89,"./views/PictView-DataBeacon-ConnectionForm.js":90,"./views/PictView-DataBeacon-ConnectionList.js":91,"./views/PictView-DataBeacon-Connections.js":92,"./views/PictView-DataBeacon-Dashboard.js":93,"./views/PictView-DataBeacon-Endpoints.js":94,"./views/PictView-DataBeacon-Introspection.js":95,"./views/PictView-DataBeacon-IntrospectionControls.js":96,"./views/PictView-DataBeacon-IntrospectionTables.js":97,"./views/PictView-DataBeacon-Layout.js":98,"./views/PictView-DataBeacon-QueryPanel.js":99,"./views/PictView-DataBeacon-RecordBrowser.js":100,"./views/PictView-DataBeacon-Records.js":101,"./views/PictView-DataBeacon-SQL.js":102,"./views/PictView-DataBeacon-SavedQueriesList.js":103,"./views/PictView-DataBeacon-SettingsPanel.js":104,"./views/PictView-DataBeacon-Sidebar.js":105,"./views/PictView-DataBeacon-TopBar-Nav.js":106,"./views/PictView-DataBeacon-TopBar-User.js":107,"pict-application":5,"pict-router":13,"pict-section-code":16,"pict-section-connection-form":19,"pict-section-modal":29,"pict-section-theme":30}],84:[function(require,module,exports){/**
...
window.DataBeaconApplication=libDataBeaconApplication;},{"./Pict-Application-DataBeacon.js":83,"./providers/Pict-Provider-DataBeacon-Export.js":85,"./providers/Pict-Provider-DataBeacon-Icons.js":86,"./providers/Pict-Provider-DataBeacon-SavedQueries.js":87,"./providers/Pict-Provider-DataBeacon.js":88,"./views/PictView-DataBeacon-ConnectionForm.js":90,"./views/PictView-DataBeacon-ConnectionList.js":91,"./views/PictView-DataBeacon-Connections.js":92,"./views/PictView-DataBeacon-Dashboard.js":93,"./views/PictView-DataBeacon-Endpoints.js":94,"./views/PictView-DataBeacon-Introspection.js":95,"./views/PictView-DataBeacon-IntrospectionControls.js":96,"./views/PictView-DataBeacon-IntrospectionTables.js":97,"./views/PictView-DataBeacon-Layout.js":98,"./views/PictView-DataBeacon-QueryPanel.js":99,"./views/PictView-DataBeacon-RecordBrowser.js":100,"./views/PictView-DataBeacon-Records.js":101,"./views/PictView-DataBeacon-SQL.js":102,"./views/PictView-DataBeacon-SavedQueriesList.js":103,"./views/PictView-DataBeacon-SettingsPanel.js":104,"./views/PictView-DataBeacon-Sidebar.js":105,"./views/PictView-DataBeacon-TopBar-Nav.js":106,"./views/PictView-DataBeacon-TopBar-User.js":107,"pict-application":5,"pict-router":13,"pict-section-code":16,"pict-section-theme":30,"pict-view":80}],85:[function(require,module,exports){/**
...
let tmpFormView=this.pict.views['PictSection-ConnectionForm'];let tmpConnInfo=tmpFormView&&typeof tmpFormView.getProviderConfig==='function'?tmpFormView.getProviderConfig():{Provider:'MySQL',Config:{}};this.pict.providers.DataBeaconProvider.createConnection({Name:tmpName,Type:tmpConnInfo.Provider||'MySQL',Config:tmpConnInfo.Config||{},AutoConnect:tmpAutoConnect,Description:tmpDescription});}}module.exports=PictViewDataBeaconConnectionForm;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],91:[function(require,module,exports){/**
...
<tr>
	...
	<td>{~D:Record.Type~}</td>
	<td><span class="badge {~D:Record.StatusBadgeClass~}">{~D:Record.StatusLabel~}</span></td>
</tr>`}],Renderables:[{RenderableHash:'DataBeacon-Dashboard',TemplateHash:'DataBeacon-Dashboard-Template',ContentDestinationAddress:'#DataBeacon-View-Dashboard',RenderMethod:'replace'}]};class PictViewDataBeaconDashboard extends libPictView{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){let tmpIcons=this.pict.providers['DataBeacon-Icons'];if(tmpIcons)tmpIcons.injectIconPlaceholders('#DataBeacon-View-Dashboard');return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconDashboard;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],94:[function(require,module,exports){/**
...
let tmpProvider=this.pict.providers.DataBeaconProvider;if(tmpProvider&&typeof tmpProvider.refreshIntrospectionViewData==='function'){tmpProvider.refreshIntrospectionViewData();}return super.onBeforeRender(pRenderable);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){if(this.pict.views.IntrospectionControls)this.pict.views.IntrospectionControls.render();if(this.pict.views.IntrospectionTables)this.pict.views.IntrospectionTables.render();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconIntrospection;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],96:[function(require,module,exports){/**
...
let tmpCenter=document.getElementById('DataBeacon-Workspace');if(tmpCenter){tmpCenter.innerHTML=''+'<div id="DataBeacon-View-Dashboard"      class="view-panel"></div>'+'<div id="DataBeacon-View-Connections"    class="view-panel" style="display:none;"></div>'+'<div id="DataBeacon-View-Introspection"  class="view-panel" style="display:none;"></div>'+'<div id="DataBeacon-View-Endpoints"      class="view-panel" style="display:none;"></div>'+'<div id="DataBeacon-View-Records"        class="view-panel" style="display:none;"></div>'+'<div id="DataBeacon-View-SQL"            class="view-panel" style="display:none;"></div>';}}getSidebarPanel(){return this._shell?this._shell.getPanel('sidebar'):null;}getSettingsPanel(){return this._shell?this._shell.getPanel('settings'):null;}toggleSidebar(){let p=this.getSidebarPanel();if(p&&typeof p.toggle==='function')p.toggle();}toggleSettingsPanel(){let p=this.getSettingsPanel();if(p&&typeof p.toggle==='function')p.toggle();}/**
	 ...
	 */setActiveView(pViewName){this.pict.AppData.CurrentView=pViewName;// Toggle panel visibility.
for(let i=0;i<_NavItems.length;i++){let tmpName=_NavItems[i].View;let tmpPanelList=this.pict.ContentAssignment.getElement(`#DataBeacon-View-${tmpName}`);if(tmpPanelList&&tmpPanelList.length>0){tmpPanelList[0].style.display=tmpName===pViewName?'block':'none';}}// Re-render the sidebar so its active-state highlight follows the
...
let tmpView=this.pict.views[pViewName];if(tmpView&&typeof tmpView.render==='function'){tmpView.render();}}}module.exports=PictViewDataBeaconLayout;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],99:[function(require,module,exports){/**
...
</div>`}],Renderables:[{RenderableHash:'DataBeacon-SQLPage',TemplateHash:'DataBeacon-SQLPage-Template',ContentDestinationAddress:'#DataBeacon-View-SQL',RenderMethod:'replace'}]};class PictViewDataBeaconSQL extends libPictView{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){if(this.pict.views.SavedQueriesList)this.pict.views.SavedQueriesList.render();if(this.pict.views.QueryPanel)this.pict.views.QueryPanel.render();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconSQL;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],103:[function(require,module,exports){/**
...
let tmpIcons=this.pict.providers['DataBeacon-Icons'];if(tmpIcons&&typeof tmpIcons.injectIconPlaceholders==='function'){tmpIcons.injectIconPlaceholders('#DataBeacon-Sidebar-Host');}this.pict.CSSMap.injectCSS();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconSidebar;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],106:[function(require,module,exports){/**
...
</div>`}],Renderables:[{RenderableHash:'DataBeacon-TopBar-Nav-Display',TemplateHash:'DataBeacon-TopBar-Nav-Template',ContentDestinationAddress:'#Theme-TopBar-Nav',RenderMethod:'replace'}]};class PictViewDataBeaconTopBarNav extends libPictView{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){this.pict.CSSMap.injectCSS();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconTopBarNav;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}],107:[function(require,module,exports){/**
...
let tmpIcons=this.pict.providers['DataBeacon-Icons'];if(tmpIcons&&typeof tmpIcons.injectIconPlaceholders==='function'){tmpIcons.injectIconPlaceholders('#Theme-TopBar-User');}return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconTopBarUser;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":80}]},{},[84])(84);});
